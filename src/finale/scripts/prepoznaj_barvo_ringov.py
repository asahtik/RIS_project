...
prediction = 'n.a.'
PATH1 = os.path.dirname(os.path.realpath(__file__)) + '/training1.data'
PATH2 = os.path.dirname(os.path.realpath(__file__)) + '/test1.data'
...
def knn(training_data, test_data):
    ...
    k = 2  # K value of k nearest neighbor
...
def prepoznaj_barvo():
	...
	s = rospy.Service('finale/prepoznaj_ring', BarvaCilindrov, prepoznaj)
